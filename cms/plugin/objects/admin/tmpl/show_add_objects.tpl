...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		x.value = (d.getFullYear()-1911).toString() + '-' + month + '-' + day;
...
<div id="content">
    ...
    <h4><{$func_Cname}></h4>
    <p class="notes">(*為必填)</p>
	<form name="addForm" id="addForm" method="POST" action="<{$do_add_objects_url}>" enctype="multipart/form-data">
       ...
       <table summary="services">
            ...
            <tbody>
              <tr>
				...
				<td>
					<input type="field" name="obj[publish_date]" value="<{$publish_date}>" id="datepicker" maxlength="10" class="required" />
				</td>
              </tr>	
              <tr class="odd">
				<th scope="row" class="column1">* 區域</th>
				<td>
					<select  name="obj[county]" id="county" onChange="changeSection()" class="required"> 
              ...
              <tr>
				...
				<td>
					<input type="text" name="obj[obj_addr]" id="obj_addr" onChange="remind(this.value)" value="" class="addressCheck required" />
				</td>
              </tr>
              <tr class="odd">
              ...
              <tr>
				...
				<td>
					<select name="obj[auction_inst]" class="required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; font-style:normal; font-weight:bold; text-decoration:none" onchange="this.style.color=this.options[this.selectedIndex].style.color">
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="台北法院" style=" color:#993300;">台北法院</OPTION>
						<OPTION value="士林法院" style=" color:#993300;">士林法院</OPTION>
						<OPTION value="板橋法院" style=" color:#993300;">板橋法院</OPTION>
						<OPTION value="桃園法院" style=" color:#993300;">桃園法院</OPTION>
						<OPTION value="台灣金服公司" style="color:#FFCC00">台灣金服公司</OPTION>
						<OPTION value="台北執行處" style="color:#0000FF">台北執行處</OPTION>
						<OPTION value="士林執行處" style="color:#0000FF">士林執行處</OPTION>
						<OPTION value="板橋執行處" style="color:#0000FF">板橋執行處</OPTION>
						<OPTION value="桃園執行處" style="color:#0000FF">桃園執行處</OPTION>
						<OPTION value="其他機關" style="color:#000000">其他機關</OPTION>
					</select>
				</td>
              </tr>	
              <tr class="odd">
				...
				<td>
					<input type="field" name="obj[auction_no]" value="" id="auction_no" class="auctionCheck required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 16px; color:#993300; font-style:normal; font-weight:bold; text-decoration:none" />
				</td>
              </tr>	
              <tr>
				<th scope="row" class="column1">* 拍次</th>
				<td>
					<select  name="obj[auction_times]" class="required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; font-style:normal; font-weight:normal; text-decoration:none" onchange="this.style.color=this.options[this.selectedIndex].style.color">
						<OPTION value="" selected>--請選擇--</OPTION>
						...
						<OPTION value="應買" style="color:#9900CC">應買</OPTION>
              ...
              <tr class="odd">
				...
				<td>
					<select  name="obj[auction_checked]" class="required" class="required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; font-style:normal; font-weight:normal; text-decoration:none" onchange="this.style.color=this.options[this.selectedIndex].style.color">
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="點交" style="color:#006600">點交</OPTION>
						<OPTION value="部分點交" style="color:#FF6600">部分點交</OPTION>
						<OPTION value="不點交" style="color:#FF0000">不點交</OPTION>
					</select>
				</td>
              </tr>	
              <tr>
				...
				<td>
					<input type="field" name="obj[auction_date]" id="datepicker2" maxlength="10" class="required" />
				</td>
              </tr>	
              <tr class="odd">
				<th scope="row" class="column1">* 投標時間</th>
				<td>
					<select  name="obj[auction_time]" class="required">
					<OPTION value="" selected>--請選擇--</OPTION>
              ...
              <tr>
				...
				<td>
					<input type="field" name="obj[auction_base_price]" id="auction_base_price" onBlur="calPrice('auction_base_price','total_area','announce_unit_price')" value="" class="required number" style="background-color:#FFFFFF; text-align: right ; font-family:'Arial'; font-size: 16px; font-style:normal; font-weight:bold; text-decoration:none" />&nbsp;&nbsp;萬元
				</td>
              </tr>	
              <tr class="odd">
				<th scope="row" class="column1">* 保證金</th>
				<td>
					<input type="field" name="obj[margin]" value="" class="required number" style="background-color:#FFFFFF; text-align: right ; font-family:'Arial'; font-size: 16px; font-style:normal; font-weight:bold; text-decoration:none" />&nbsp;&nbsp;萬元
				</td>
              </tr>
              <tr>
				<th scope="row" class="column1">* 開標結果</th>
				<td>
					<select  name="obj[auction_result]" class="required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; font-style:normal; font-weight:normal; text-decoration:none" onchange="this.style.color=this.options[this.selectedIndex].style.color">
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="待標中" style="color:#0000FF">待標中</OPTION>
						<OPTION value="流標" style="color:#009900">流標</OPTION>
						<OPTION value="停拍" style="color:#FF6600">停拍</OPTION>
						<OPTION value="撤回" style="color:#FF0000">撤回</OPTION>
						<OPTION value="拍定" style="color:#FF0000">拍定</OPTION>
					</select>
					&nbsp;&nbsp;
					<input type="field" name="obj[auction_result_memo]" class="required" style="color:#FF0000; text-align: left ; font-family:'Arial'; font-size: 13px; font-style:normal; font-weight:normal; text-decoration:none" >
				</td>
              </tr>	
			  <tr class="odd">
				<th scope="row" class="column1">* 每坪單價</th>
				<td>
					<input type="field" name="obj[announce_unit_price]" value="" id="announce_unit_price" class="number" style="background-color:#FFFFFF; text-align: right ; font-family:'Arial'; font-size: 16px; color:#ff0000; font-style:normal; font-weight:bold; text-decoration:none" />&nbsp;&nbsp;<span style="color:#0000FF; font-size:16px;">萬元 <strong>(公告底價/建物總坪數)</strong></span>
				</td>
			  </tr>
              <tr>
				<th scope="row" class="column1">* 拍定單價</th>
				<td>
					<span style="font-family:'Arial'; font-size: 16px; color:#ff0000; font-style:normal; "><strong>拍定價</strong></span><input type="field" name="obj[auction_price]" value="" class="number" onBlur="calPrice('auction_price','total_area','unit_price')" id="auction_price" style="text-align: right ; font-family:'Arial'; font-size: 16px; color:#ff0000; font-style:normal; " />&nbsp;&nbsp;<span style="color:#0000FF; font-size:16px;">萬元</span>&nbsp;&nbsp;
					<span style="font-family:'Arial'; font-size: 16px; color:#ff0000; font-style:normal; "><strong>拍定單價</strong></span><input type="field" name="obj[unit_price]" value="" id="unit_price" class="number" style="background-color:#FFFFFF; text-align: right ; font-family:'Arial'; font-size: 16px; color:#ff0000; font-style:normal; font-weight:bold; text-decoration:none" />&nbsp;&nbsp;<span style="color:#0000FF; font-size:16px;">萬元 <strong>(拍定價/建物總坪數)</strong></span>
				</td>
              </tr>			  
		  </tbody>
        </table>
            ...
            <tbody>
              <tr>
				...
				<td>
					...
					<input type="field" name="land[land_ping]" value="" class="required number" />&nbsp;&nbsp;坪
				</td>
              </tr>	
              <tr class="odd">
				<th scope="row" class="column1">* 土地增值稅</th>
				<td>
					<input type="radio" name="land[tax]" value="0" class="{required:true}" />無 
					&nbsp;&nbsp;
					<input type="radio" name="land[tax]" value="1" id="hasTax" class="{required:true}" />有
					&nbsp;&nbsp;
					<input type="field" name="land[tax_value]" value="" class="{required:#hasTax:checked} number" onKeyup="showMsg(this.value)" />萬
					&nbsp;&nbsp;
					<input type="radio" name="land[tax]" value="2" class="{required:true}" />未確定
<div id="taxMsg" style="display:none"><span style="color:#000000; font-size:16px;">土地拍賣底價低於土地公告現值，將來移轉時需負擔土地增值稅。</span><span style=" font-family:'Verdana'; color:#000000; font-size:16px;">(</span><span style=" font-family:'\'b7\'73\'b2\'d3\'a9\'fa\'c5\'e9'; color:#009900; font-size:16px;">自用稅率</span><span style=" font-family:'Verdana'; color:#000000; font-size:16px;"> 10%</span><span style="color:#000000; font-size:16px;">；</span><span style="color:#FF6600; font-size:16px;">一般稅率</span><span style=" font-family:'Verdana'; color:#000000; font-size:16px;"> 20%, 30%, 40%)</span></div>
              ...
              <tr>
				...
				<td>
					<span style="color:#006600; font-size:16px;">完工年份:</span>
						<input type="field" name="land[deadline]" class="required number" />年&nbsp;&nbsp;&nbsp;&nbsp;
					<span style="color:#006600; font-size:16px;">結構:</span>
						<select name="land[structure]" class="required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; color:#000000; font-style:normal; font-weight:normal; text-decoration:none" >
							<OPTION value="">--請選擇--</OPTION>
							<OPTION value="SRC鋼骨">SRC鋼骨</OPTION>
							<OPTION value="SRC鋼筋">SRC鋼筋</OPTION>
							<OPTION value="RC鋼筋">RC鋼筋</OPTION>
					...
					<span style="color:#006600; font-size:16px;">用途:</span>
						<select  name="land[usage]" class="required" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; color:#000000; font-style:normal; font-weight:normal; text-decoration:none" >
							...
							<OPTION value="國民住宅">國民住宅</OPTION>
							<OPTION value="住商用">住商用</OPTION>
							<OPTION value="住工用">住工用</OPTION>
							<OPTION value="工業用">工業用</OPTION>
							<OPTION value="工商用">工商用</OPTION>
							<OPTION value="其他">其他</OPTION>
						</SELECT>
				</td>
              </tr>	
              <tr class="odd">
				...
				<td><input type="field" name="land[total_area]" class="required number" onBlur="calPrice('auction_price','total_area','unit_price');calPrice('auction_base_price','total_area','announce_unit_price')" id="total_area" style="background-color:#FFFFFF; text-align: right ; font-family:'Arial'; font-size: 16px; color:#0000FF; font-style:normal; font-weight:bold; text-decoration:none" />坪</td>
              </tr>	
              <tr>
				<th scope="row" class="column1">主建物</th>
				<td><input type="field" name="land[main_area]" class="number" style="text-align: right ; font-family:'Arial'; color:#993300;" />坪</td>
              </tr>	
              <tr class="odd">
				...
				<td>
					<select  name="land[append_item][0]" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; color:#000000; font-style:normal; font-weight:normal; text-decoration:none" >
						...
						<OPTION  value="騎樓">騎樓</OPTION>
						<OPTION  value="夾層">夾層</OPTION>
						<OPTION  value="地下室">地下室</OPTION>
						<OPTION  value="增建">增建</OPTION>
						<OPTION  value="屋頂突出物">屋頂突出物</OPTION>
						<OPTION  value="公設">公設</OPTION>
						<OPTION  value="車位">車位</OPTION>
					</SELECT>
					<input name="land[append_area][0]"  type="field" class="number" value="" style="text-align: right ; font-family:'Arial';" />
					...
					<input name="land[append_area][1]"  type="field" value="" class="number" style="text-align: right ; font-family:'Arial';" />
					<span style="color:#000000; font-size:16px;">坪&nbsp;&nbsp;</span>
				</td>
              </tr>	
              <tr>
				...
				<td>
					...
					<input name="land[append_area][2]"  type="field" value="" class="number" style="text-align: right ; font-family:'Arial';" />
					<span style="color:#000000; font-size:16px;">坪&nbsp;&nbsp;</span>
					...
					<input name="land[append_area][3]"  type="field" value="" class="number" style="text-align: right ; font-family:'Arial';" />
					<span style="color:#000000; font-size:16px;">坪&nbsp;&nbsp;</span>
				</td>
              </tr>	
              <tr class="odd">
				...
				<td>
					...
					<input name="land[append_area][4]"  type="field" value="" class="number" style="text-align: right ; font-family:'Arial';" />
					<span style="color:#000000; font-size:16px;">坪&nbsp;&nbsp;</span>
					...
					<input name="land[append_area][5]"  type="field" value="" class="number" style="text-align: right ; font-family:'Arial';" />
					<span style="color:#000000; font-size:16px;">坪</span>
				</td>
              </tr>	
              <tr class="odd">
				<th scope="row" class="column1">附屬建物</th>
				<td>
					<input name="land[append_item][6]"  type="field" value="" />
					<input name="land[append_area][6]"  type="field" value="" class="number" style="text-align: right ; font-family:'Arial';" />
					<span style="color:#000000; font-size:16px;">坪</span>
				</td>
              </tr>	
            </tbody>
  ...
  <div class="step" id="thirdStep">
        <table summary="services">
            ...
            <tbody>
              ...
              <tr class="odd">
				<td>
					<input type="field" name="obj[bank_name][0]" value="" />
				</td>
				<td>
					<input type="field" name="obj[bank_value][0]" value="" class="number" />萬元
				</td>
              </tr>	
              <tr>
				<td>
					<input type="field" name="obj[bank_name][1]" value="" />
				</td>
				<td>
					<input type="field" name="obj[bank_value][1]" value="" class="number" />萬元
				</td>
              </tr>	
              <tr class="odd">
				<td>
					<input type="field" name="obj[bank_name][2]" value="" />
				</td>
				<td>
					<input type="field" name="obj[bank_value][2]" value="" class="number" />萬元
				</td>
              </tr>	
           </tbody>
		   <tr style="border-width:0 0 0 0;height:16px">
            ...
            <tbody>
              ...
              <tr class="odd">
				<td>
					<input type="field" name="obj[seal_date]" value="" id="datepicker3" maxlength="10" />
				</td>
				<td>
					<input type="text" name="obj[debtee]" value="" />
				</td>
              </tr>	
              <tr>
				<td colspan="2">
        ...
        <table summary="services">
            ...
            <tbody>
              ...
              <tr class="odd">
				...
				<td>
					<input type="text" name="obj[community]" value="" />
				</td>
              </tr>	
              <tr>
				<th scope="row" class="column1">管理費</th>
				<td>
                    <select  name="obj[management_fee_type]">                      
					  <option value="">--請選擇--</option>
					  <option value="每月">每月</option>
					  <option value="每坪">每坪</option>
					  <option value="每季">每季</option>
                    </select>&nbsp;&nbsp;
					<input type="field" name="obj[management_fee]" />元
				</td>
              </tr>	
              <tr class="odd">
				<th scope="row" class="column1">房屋租金</th>
				<td>
                    <select  name="obj[rent_type]">                      
					  <option value="">--請選擇--</option>
					  <option value="每月">每月</option>
					  <option value="每坪">每坪</option>
                    </select>&nbsp;&nbsp;
					<input type="field" name="obj[rent_fee]" />元
				</td>
              </tr>	
              <tr>
				<th scope="row" class="column1">車位租金</th>
				<td>
                    <select  name="obj[parking_type]">                      
					  <option value="">--請選擇--</option>
					  <option value="平面">平面</option>
					  <option value="機械">機械</option>
                    </select>&nbsp;&nbsp;
					<input type="field" name="obj[parking_fee]" class="number" />元
				</td>
              </tr>	
              <tr class="odd">
				...
				<td>
					...
					<input type="text" name="obj[area_intro_desc]" value="輸入圖片說明" onFocus="if(this.value=='輸入圖片說明')this.value=''" onBlur="if(this.value=='')this.value='輸入圖片說明'" />
				</td>
              </tr>
		  </tbody>
        </table>
        ...
        <table summary="services">
            ...
            <tbody>
              ...
              <tr class="odd">
				...
				<td>
					<input type="text" name="obj[quotations_addr][0]" value="" />
				</td>
              </tr>	
              <tr>
				<th scope="row" class="column1">類型</th>
				<td>
					<select  name="obj[quotations_type][0]">
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="大樓／住家">大樓／住家</OPTION>
						<OPTION value="大樓／住辦">大樓／住辦</OPTION>
						<OPTION value="大樓／套房">大樓／套房</OPTION>
			  ...
			  <tr class="odd">
				...
				<td>
					<input type="field" name="obj[quotations_date][0]" id="datepicker4" maxlength="10" />
				</td>
			  </tr>
              <tr>
				<th scope="row" class="column1">拍次</th>
				<td>
					<select  name="obj[quotations_times][0]" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; color:#0000FF; font-style:normal; font-weight:normal; text-decoration:none" >
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="1拍" style="color:#0000FF">1拍</OPTION>
						<OPTION value="2拍" style="color:#0000FF">2拍</OPTION>
						<OPTION value="3拍" style="color:#0000FF">3拍</OPTION>
              ...
              <tr class="odd">
				...
				<td>
					<input type="field" name="obj[quotations_price][0]" value="" id="qp1" onBlur="calPrice('qp1','area1', 'p1')" class="number" />&nbsp;&nbsp;萬元
				</td>
              </tr>				  
              <tr>
				<th scope="row" class="column1">總坪數</th>
				<td>
					<input type="field" name="obj[quotations_totalprice][0]" value="" id="area1" onBlur="calPrice('qp1','area1', 'p1')" class="number" />&nbsp;&nbsp;坪
				</td>
              </tr>				  
              <tr class="odd">
				<th scope="row" class="column1">單價</th>
				<td>
					<input type="field" name="obj[quotations_unitprice][0]" value="" id="p1" class="number" />&nbsp;&nbsp;<span style="color:#0000FF; font-size:16px;">萬元 (拍定價金/建物總坪數)</span>
				</td>
              </tr>
              <tr>
              ...
              <tr class="odd">
				<th scope="row" class="column1">地址</th>
				<td>
					<input type="text" name="obj[quotations_addr][1]" value="" />
				</td>
              </tr>	
              <tr>
				<th scope="row" class="column1">類型</th>
				<td>
					<select  name="obj[quotations_type][1]">
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="大樓／住家">大樓／住家</OPTION>
						<OPTION value="大樓／住辦">大樓／住辦</OPTION>
						<OPTION value="大樓／套房">大樓／套房</OPTION>
			  ...
			  <tr class="odd">
				<th scope="row" class="column1">拍定日期</th>
				<td>
					<input type="field" name="obj[quotations_date][1]" id="datepicker5" maxlength="10" />
				</td>
			  </tr>
              <tr>
				<th scope="row" class="column1">拍次</th>
				<td>
					<select  name="obj[quotations_times][1]" style="background-color:#FFFFFF; text-align: left ; font-family:'Arial'; font-size: 13px; color:#0000FF; font-style:normal; font-weight:normal; text-decoration:none" >
						<OPTION value="" selected>--請選擇--</OPTION>
						<OPTION value="1拍" style="color:#0000FF">1拍</OPTION>
						<OPTION value="2拍" style="color:#0000FF">2拍</OPTION>
						<OPTION value="3拍" style="color:#0000FF">3拍</OPTION>
              ...
              <tr class="odd">
				<th scope="row" class="column1">拍定價金</th>
				<td>
					<input type="field" name="obj[quotations_price][1]" value="" id="qp2" onBlur="calPrice('qp2','area2', 'p2')" class="number" />&nbsp;&nbsp;萬元
				</td>
              </tr>				  
              <tr>
				<th scope="row" class="column1">總坪數</th>
				<td>
					<input type="field" name="obj[quotations_totalprice][]" value="" id="area2" onBlur="calPrice('qp2','area2', 'p2')" class="number" />&nbsp;&nbsp;坪
				</td>
              </tr>				  
              <tr class="odd">
				<th scope="row" class="column1">單價</th>
				<td>
					<input type="field" name="obj[quotations_unitprice][1]" value="" id="p2" class="number" />&nbsp;&nbsp;<span style="color:#0000FF; font-size:16px;">萬元 (拍定價金/建物總坪數)</span>
				</td>
              </tr>
              <tr>
				<th scope="row" class="column1">相片</th>
        ...
        <table summary="services">
            ...
            <tbody>
              ...
              <tr class="odd">
				...
				<td>
					<input type="text" name="obj[house_desc][]" value="" />
				</td>
              </tr>
              <tr>
        ...
        <table summary="services">
            ...
            <tbody>
              ...
              <tr>
				...
				<td>
					<input type="file" name="obj[structure_other_pic]" />&nbsp;&nbsp;<input type="text" name="obj[structure_desc]" value="輸入圖片說明" onFocus="if(this.value=='輸入圖片說明')this.value=''" onBlur="if(this.value=='')this.value='輸入圖片說明'" />
				</td>
              </tr>
		  </tbody>
		   <tr style="border-width:0 0 0 0;height:16px;background-color:#FFFFFF">
            ...
            <tbody>
              <tr>
				...
				<td>
					<input type="file" name="obj[pic][]" />&nbsp;&nbsp;<input type="text" name="obj[pic_desc][]" value="輸入圖片說明" onFocus="if(this.value=='輸入圖片說明')this.value=''" onBlur="if(this.value=='')this.value='輸入圖片說明'" />
				</td>
              </tr>
              <tr class="odd">
  ...
  <div class="step" id="tenthStep">
        <table summary="services">
            ...
            <tbody>
              <tr>
				<td>
				<textarea rows="" cols="" name="obj[analysis_memo]"></textarea>
				</td>
              </tr>
		  </tbody>
        </table>
