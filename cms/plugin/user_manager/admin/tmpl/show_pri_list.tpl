...
<div id="content">
		...
		<hr/>
          <h5><{$func_Cname}></h5>
              <input type="button"name="button"class="button100" value="新增身份" onClick="aHover('<{$show_add_pri_link}>')" title=""/>
...
<tr>
	...
	<td class="column1"><{$rows.pri_id}></td>
	<td class="column1"><{$rows.pri_name}></td>
	<td>		  
		<input type="button"name="button"class="button60" value="變更"title="" onClick="aHover('<{$rows.show_edit_pri_link}>')" />	       
	</td>
	<td>
	  <input type="button"name="button"class="button60" value="刪除"title="" onClick="showDelDialog('<{$rows.do_del_pri_link}>')" />		
	</td>
</tr>
<{/foreach}>
	</tbody>
