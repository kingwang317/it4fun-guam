...
<div id="calDialog"><span id="calText"></span><hr/><div id="calBtn"><input type="button" class="button60" value="確定" onClick='calHover()' />&nbsp;&nbsp;&nbsp;<a href="#" onClick='calAdd()' />我反悔了</a></div><input type="hidden" id="calUrl" value=""></div>
	<div id="content">
		...
		<form action="<{$do_add_kp_url}>" method="POST" >
...
<{/foreach}>
        ...
        <div id="sub_content">
          ...
          <br />
          <input type="text" class="url" name="kp_qid" id="kp_qid" />
          ...
          <div id="paper_box">
            <table >
              <tr>
                ...
                <td colspan="4" ><input type="text" name="kp_title" id="kp_title" class="paper_title" /></td>
                <td>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td><label class="radio1">
                  <input type="radio" name="kp_status" value="未處理" />
                  未處理</label>
                </td>
                <td><input type="radio" name="kp_status" value="處理中" />
                  處理中 </td>
                <td><input type="radio" name="kp_status" value="已處理" />
                  已處理 </td>
                <td><input type="radio" name="kp_status" value="不處理" />
                  不處理 </td>
                <td></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input type="radio" name="kp_cate" value="未分類" />
                  未分類 </td>
                <td><input type="radio" name="kp_cate" value="品牌" />
                  品牌 </td>
                <td><input type="radio" name="kp_cate" value="產品" />
                  產品 </td>
                <td><input type="radio" name="kp_cate" value="售後服務" />
                  售後服務 </td>
                <td><input type="radio" name="kp_cate" value="銷售" />
                  銷售 </td>
              </tr>
              <tr>
                <td></td>
                <td><input type="radio" name="kp_cate" value="行銷活動" />
                  行銷活動 </td>
                <td><input type="radio" name="kp_cate" value="主動宣傳" />
                  主動宣傳 </td>
                <td><input type="radio" name="kp_cate" value="其他" />
                  其他 </td>
                <td></td>
                <td></td>
              </tr>
              ...
              <tr>
                ...
                <td><input type="radio" name="kp_rank" value="未分類" />
                  未分類 </td>
                <td><input type="radio" name="kp_rank" value="正面" />
                  正面 </td>
                <td><input type="radio" name="kp_rank" value="一般" />
                  一般 </td>
                <td><input type="radio" name="kp_rank" value="負面" />
                  負面 </td>
                <td><input type="radio" name="kp_rank" value="惡意攻擊" />
                  惡意攻擊</td>
              </tr>
            </table>
            <br/>
