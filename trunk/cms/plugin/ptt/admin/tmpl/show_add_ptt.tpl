...
<div id="calDialog"><span id="calText"></span><hr/><div id="calBtn"><input type="button" class="button60" value="確定" onClick='calHover()' />&nbsp;&nbsp;&nbsp;<a href="#" onClick='calAdd()' />我反悔了</a></div><input type="hidden" id="calUrl" value=""></div>
	<div id="content">
		...
		<form action="<{$do_add_ptt_url}>" method="POST" >
...
<{/foreach}>
		...
		<select id="broad_sel" name="broad_sel">
			...
			<{foreach from="$broad_data" item="broad_rows" name="broad_data"}>
				<option value="<{$broad_rows.ptt_bid}>"><{$broad_rows.ptt_bid}></option>
			<{/foreach}>
		</select><br/>
          ...
          <div id="paper_box">
            <table >
              <tr>
                ...
                <td colspan="4" ><input type="text" name="ptt_pid" id="ptt_pid" class="ptt_pid" /></td>
                <td>
                </td>
              </tr>
              <tr>
                <td><label class="title">文章標題:</label></td>
                <td colspan="4" ><input type="text" name="ptt_title" id="ptt_title" class="paper_title" /></td>
                <td>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="4" ><input type="text" name="ptt_post_time" class="post_dat" id="ptt_post_time" /></td>
                <td>
                </td>
              ...
              <tr>
                ...
                <td colspan="4" ><input type="text" name="ptt_track_time" class="post_dat" id="ptt_track_time" /></td>
                <td>
                </td>
