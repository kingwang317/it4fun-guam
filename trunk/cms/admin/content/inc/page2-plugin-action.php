...
switch($_REQUEST['action']){
	case 'edit':
		...
		$myNode->setAttribute('addWay',$_POST['addWay']);
	...
	case 'add':
		...
		$contentNode->setAttribute('method','plugin');
		$contentNode->setAttribute('addWay',$_POST['addWay']);
		$contentNode->setAttribute('folder',$_POST['folder']);
		$contentNode->setAttribute('pluginUrl',$_POST['pluginUrl']);
		$contentNode->setAttribute('pluginTitle',$_POST['pluginTitle']);
